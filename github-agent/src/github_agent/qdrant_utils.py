# DEPRECATED: All functionality has been moved to github_agent.agents.embedding_agent.EmbeddingAgent
# Please update your imports to use EmbeddingAgent instead.

# import logging

# import numpy as np
# from github_agent.config import COLLECTION_NAME, QDRANT_URL
