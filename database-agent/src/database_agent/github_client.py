...
class GitHubClient:
    ...
    def __init__(
        ...
        Args:
            token: GitHub API token. If not provided, will try to get from GITHUB_TOKEN env var.
            base_url: GitHub API base URL. If not provided, will use default GitHub API URL.
    ...
    def search_prs(
        ...
        if repo_name:
            ...
            similar_prs = [
                ...
                if pr['payload'].get('repo_name') == repo_name
            ]
    ...
    def get_pull_request_dates(self, repo_name: str, pr_number: int) -> tuple[datetime, datetime]:
